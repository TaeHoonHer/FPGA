...
vlog -vlog01compat -work work +incdir+C:/firstgate {C:/firstgate/firstgate.v}

vlog -vlog01compat -work work +incdir+C:/firstgate {C:/firstgate/firstgate_td.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  firstgate_td
